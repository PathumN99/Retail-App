...
import { ApparelCategories } from "../../../utilities/enums";
import ProductCSS from "../../../style/Product.module.css";

export default function ProductApparel() {
    ...
    const handleUpload = (e) => {
        ...
        let dataObject = {
            ...
            imageUrl: `http://localhost:5105/Images/Apparel/${selectedFile.name}`
        }

        Axios.post("http://localhost:5105/api/Apparel/insert-product", dataObject).then((response) => {
        ...
        Axios.post("http://localhost:5105/api/Apparel/image-upload", formData, {
            headers: {
            ...
            <div className={ProductCSS.productCard}>
                ...
                <div className={ProductCSS.fields}>
                    ...
                    <select className={ProductCSS.input} value={category} name="category" onChange={handleCategory}>
                        <option value={ApparelCategories.sweatpants}>Sweatshirt</option>
                        <option value={ApparelCategories.sweatpants}>Sweatpants</option>
                        <option value={ApparelCategories.tshirt}>T-Shirt</option>
                    </select>
